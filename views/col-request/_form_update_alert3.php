...
<div class="col-request-form">
    ...
    <div class="box-header with-border">
      <h4 class="box-title">บันทึก แจ้งเตือนครั้งที่ 3</h4>
   </div>
  <div class="box-body">

    <?php $form = ActiveForm::begin(); ?>

        <p class="text-muted well well-sm no-shadow"><i class="fa fa-fw fa-globe"></i> แจ้งเตือนครั้งที่ 2</p>
        <hr>
        ...
        <?= $form->field($model, 'req_alert2_comment')->textArea(['rows' => '6']) ?>


        <p class="text-muted well well-sm no-shadow"><i class="fa fa-fw fa-globe"></i> แจ้งเตือนครั้งที่ 3</p>
        <hr>
        ...
        <?= $form->field($model, 'req_alert3_comment')->textArea(['rows' => '6']) ?>
