...
<div class="col-request-form">
  ...
  <div class="box-body">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($model, 'req_report_id')->label('เลขที่หนังสือรับ') ?>
        ...
        <?//= $form->field($model, 'req_status')->dropDownlist(['ดำเนินการ'=>'ดำเนินการ','ยุติเรื่อง'=>'ยุติเรื่อง'],['prompt' => 'เลือก']) ?>
