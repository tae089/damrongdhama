 ...
 */
class ColRequest03Search extends ColRequest
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $ts = $dt->getTimestamp();
        $query = ColRequest::find()->where(['req_report_id'=>'','req_send_date'=>['$ne'=>''],'req_status'=>['$ne'=>'ยุติเรื่อง'], 'req_alert1'=>['$ne'=>''], 'req_alert2'=>['$ne'=>''],'req_out'=>'F']);
